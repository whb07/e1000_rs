...
e1000_sw_init(struct e1000_adapter *adapter) {
  ...
  switch (*device) {
    case E1000_DEV_ID_82542:
      switch (*revision) {
        case E1000_82542_2_0_REV_ID:shared->mac_type = e1000_82542_rev2_0;
          break;
        case E1000_82542_2_1_REV_ID:shared->mac_type = e1000_82542_rev2_1;
          break;
        default:shared->mac_type = e1000_82542_rev2_0;
          E1000_ERR("Could not identify 82542 revision\n");
      }
      break;
    case E1000_DEV_ID_82543GC_FIBER:
    case E1000_DEV_ID_82543GC_COPPER:shared->mac_type = e1000_82543;
      break;
    case E1000_DEV_ID_82544EI_COPPER:
    case E1000_DEV_ID_82544EI_FIBER:
    case E1000_DEV_ID_82544GC_COPPER:
    case E1000_DEV_ID_82544GC_LOM:shared->mac_type = e1000_82544;
      break;
    default:
...
e1000_configure_tx(struct e1000_adapter *adapter) {
  ...
  switch (adapter->shared.mac_type) {
    ...
    case e1000_82542_rev2_1:tipg = DEFAULT_82542_TIPG_IPGT;
...
e1000_setup_rctl(struct e1000_adapter *adapter) {
  ...
  switch (adapter->rx_buffer_len) {
    ...
    default:rctl |= E1000_RCTL_SZ_2048;
      break;
    case E1000_RXBUFFER_4096:rctl |= E1000_RCTL_SZ_4096 | E1000_RCTL_BSEX | E1000_RCTL_LPE;
      break;
    case E1000_RXBUFFER_8192:rctl |= E1000_RCTL_SZ_8192 | E1000_RCTL_BSEX | E1000_RCTL_LPE;
      break;
    case E1000_RXBUFFER_16384:rctl |= E1000_RCTL_SZ_16384 | E1000_RCTL_BSEX | E1000_RCTL_LPE;
      break;
  }
...
e1000_ioctl(struct net_device *netdev, struct ifreq *ifr, int cmd) {
  switch (cmd) {
    case SIOCETHTOOL:return e1000_ethtool_ioctl(netdev, ifr);
